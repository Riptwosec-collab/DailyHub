...
const copy = {
  th: {
    ready: "การแจ้งเตือนพร้อมใช้งาน",
    loadingTitle: "กำลังโหลดการแจ้งเตือน",
    loadingDesc: "กำลังดึง notifications จาก API",
    errorTitle: "โหลดการแจ้งเตือนไม่สำเร็จ",
    badge: "ศูนย์การแจ้งเตือน",
    title: "การแจ้งเตือน",
    desc: "ติดตามรายการสำคัญ แยกสถานะอ่านแล้วหรือยังไม่อ่าน และจัดการทุกการแจ้งเตือนจากจุดเดียว",
  ...
  en: {
    ...
    title: "Notifications",
    desc: "Track important items, separate read and unread states, and manage every notification in one place.",
