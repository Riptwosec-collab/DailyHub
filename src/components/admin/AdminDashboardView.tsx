...
const copy = {
  th: {
    ...
    desc: "ดูสถานะระบบ, task usage, โหมด OpenAI/Telegram, failed runs, audit logs และ health overview ของ DailyHub",
    usage: "การใช้งาน",
    logs: "Logs",
    errors: "Errors",
    refresh: "รีเฟรช",
  ...
  en: {
    ...
    badge: "Phase 19 Admin",
    title: "Admin / Usage Dashboard",
    desc: "View system status, task usage, OpenAI/Telegram mode, failed runs, audit logs, and DailyHub health overview.",
    usage: "Usage",
    logs: "Logs",
    errors: "Errors",
    refresh: "Refresh",
