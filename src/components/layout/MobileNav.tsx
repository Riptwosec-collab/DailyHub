...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-3 left-3 right-3 z-30 grid grid-cols-4 rounded-xl border border-white/10 bg-slate-950/90 p-2 shadow-2xl shadow-black/40 backdrop-blur-xl lg:hidden">
      {navItems.map((item) => (
