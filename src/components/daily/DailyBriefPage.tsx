...
const copy = {
  th: {
    ...
    subtitle: "ศูนย์กลางข่าวทั้งหมดของ DailyHub แปลไทยก่อนสรุป อ่านข่าวเต็มได้ และส่งข่าวย่อภาษาไทยไป Telegram ได้ทั้งรายข่าว รายหมวด หรือทั้งวัน",
    ...
    splitNote: "ถ้าข้อความยาวเกิน limit ระบบจะแบ่งส่งหลายข้อความอัตโนมัติ และแสดงจำนวน part จาก API",
  ...
  en: {
    ...
    subtitle: "DailyHub's main news center. News is normalized into Thai before summarization, full sources stay readable, and compact Thai summaries can be sent to Telegram by story, category, or whole brief.",
    ...
    splitNote: "If the message exceeds Telegram limits, the system splits it into multiple parts and reports the part count from the API.",
